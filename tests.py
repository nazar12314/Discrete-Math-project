...
assert list(main.combinations_with_replacement('ABC', 2)) == [('A', 'A'), ('A', 'B'), ('A', 'C'),
                                                              ('B', 'B'), ('B', 'C'), ('C', 'C')]
...
assert len(list(main.combinations_with_replacement([element for element in range(100)], 3))) == 171700
